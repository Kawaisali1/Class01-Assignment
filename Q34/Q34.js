...
*/
var pizza_names = ['Pepperoni', 'Veggie', 'Cheesy Pizza'];
for (var _i = 0, pizza_names_1 = pizza_names; _i < pizza_names_1.length; _i++) {
    var pizzas = pizza_names_1[_i];
    console.log("I don't like ".concat(pizzas, " pizza"));
}
console.log("Honestly, I don't like any kind of pizzas.");
